<template>
    ...
    <div class="d-flex justify-content-start align-items-center flex-nowrap w-100 mt-3">
        <TaskContainer v-for="s in data" :status="s" :key="s.id" @status-delete="statusDelete" :demo="true" @open-form="toggleStatusForm" :tasks="task"/>
    </div>
